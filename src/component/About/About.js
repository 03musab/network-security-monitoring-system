  ...
  return (
    <div className="app">
      ...
      <main className='content'>
        <Topbar />
        <Box m="20px">
          <Header title="About" subtitle="Information about the NSMS " />
          ...
          <div
            ...
            <AccordionDetails>
              <p>A security monitoring system is a critical component for ensuring the safety and protection of individuals and assets in a variety of settings.
                ...
                <br></br>With these key features, a security monitoring system can help businesses and organizations protect their valuable data and assets, mitigate risks, and maintain compliance with regulatory requirements.
              </p>
            </AccordionDetails>
          </div>
          <br>
